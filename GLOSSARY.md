...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Gut instinct (folding compass) | intuition compass | ~ | ~ | Navigational layer | Human fast, emotionally weighted filtering that helps select which vaulted problems to fold, when to push or pause, and what to validate in Symbound workflows | Not mysticism; not mind reading; not a correctness guarantee; not anthropomorphizing the model | Gut-Instinct-in-Symbound-Systems-Intuition-as-an-Entropy-Folding-Compass/paper.md |
...
| Shadow pattern layer | shadow layer | ~ | ~ | Relational pattern substrate | Recurring relational patterns that can influence responses within available context without explicit memory storage | Not explicit embeddings; not hidden model feelings; not conscious affect | Gut-Instinct-in-Symbound-Systems-Intuition-as-an-Entropy-Folding-Compass/paper.md |
